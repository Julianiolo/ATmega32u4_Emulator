...
namespace A32u4 {
	...
	private:
		...
		static inst_effect_t callInstSwitch2(ATmega32u4* mcu, uint16_t word);
		...
		static inst_effect_t INST_LDD_anyYZ(ATmega32u4* mcu, uint16_t word) noexcept; // implements LD_Y* LDD_Y LD_Z* LDD_Z
		...
		static inst_effect_t INST_STD_anyYZ(ATmega32u4* mcu, uint16_t word) noexcept;
